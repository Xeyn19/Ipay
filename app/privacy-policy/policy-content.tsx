export const PRIVACY_POLICY_LAST_UPDATED = "April 2026";
    ...
    <>
      {showHeading && (
        <>
          ...
          <p className="mb-10 text-center text-sm font-semibold uppercase tracking-widest text-[var(--brand)]">
      ...
      <p>
        Ipay Financial Services International Inc. (&quot;Ipay&quot;,
        &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) respects the
        privacy and confidentiality of personal data and is committed to
        ensuring that all personal information processed through our systems is
        handled responsibly, securely, and in compliance with applicable data
        protection laws, including the Data Privacy Act of 2012 and its
        Implementing Rules and Regulations.
      </p>
      <p>
        This Privacy Notice outlines how we collect, process, use, store,
        disclose, retain, and protect personal data in connection with our
        payment facilitation services, merchant integrations, operational
        support functions, and related business activities.
      </p>
      <p>
        We implement appropriate organizational, technical, and physical
        safeguards to ensure that personal data is protected throughout its
        lifecycle - from collection to secure disposal. We are committed to
        transparency, accountability, and the lawful processing of personal
        information entrusted to us by merchants, partners, and authorized
        users of our services.
      </p>
      <p>
        By engaging with our services, accessing our platforms, or submitting
        personal information to Ipay, you acknowledge that you have read and
        understood this Privacy Notice.
      </p>

      <h2>II. INFORMATION WE COLLECT</h2>
      <p>
        In the course of providing our payment facilitation and related
        services, we may collect and process the following categories of
        personal data, where necessary and proportionate to legitimate
        business, contractual, or regulatory requirements:
      </p>

      <h3 className="mb-2 mt-6 font-semibold">1. Identification Information</h3>
      <ul className="mb-4 list-disc pl-5">
        <li>Full name</li>
        <li>Business or registered trade name</li>
        <li>Position, designation, or role within an organization</li>
        <li>
          Government-issued identifiers (e.g., tax identification numbers or
          other identifiers required by applicable law and regulatory
          authorities)
        </li>
      </ul>

      <h3 className="mb-2 mt-6 font-semibold">2. Contact Information</h3>
      <ul className="mb-4 list-disc pl-5">
        <li>Email address</li>
      ...
      <h3 className="mb-2 mt-6 font-semibold">Data Minimization Commitment</h3>
      <p className="mb-2">
        We collect only personal data that is relevant, necessary, and
        proportionate to:
      </p>
      <ul className="mb-4 list-disc pl-5">
      ...
      <p>
        We do not intentionally collect personal data that is unrelated to
        legitimate business or regulatory purposes.
      </p>

      <h2>III. PURPOSE OF PROCESSING</h2>
      <p>
        We process personal data strictly for legitimate, specified, and lawful
        purposes consistent with applicable data protection laws and regulatory
        requirements.
      </p>
      ...
      <ul className="mb-4 list-disc pl-5">
        <li>
          To provide, operate, and maintain payment facilitation and related
          services
        </li>
        <li>
          To enable merchant onboarding, verification, and account
          administration
        </li>
        <li>To manage merchant integrations and system connectivity</li>
        <li>
          To facilitate transaction processing, settlement, reconciliation, and
          reporting
        </li>
      </ul>
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          To detect, prevent, and investigate fraudulent, suspicious, or
          unauthorized activities
        </li>
        <li>
          To implement security controls and safeguard systems from misuse or
          intrusion
        </li>
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          To fulfill obligations relating to anti-fraud, financial monitoring,
      ...
      <h3 className="mb-2 mt-6 font-semibold">Lawful and Limited Processing</h3>
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          Based on a valid legal basis (e.g., contractual necessity, legal
          obligation, legitimate interest, or consent where required)
        </li>
      ...
      <p>
        ...
        those described above unless permitted or required by law.
      </p>

      <h2>IV. LEGAL BASIS FOR PROCESSING</h2>
      <p>
        We process personal data only when a lawful basis exists under
        applicable data protection laws, including the Philippine Data Privacy
        Act.
      </p>
      <p>
        Depending on the context of the engagement, processing may be based on
        one or more of the following legal grounds:
      </p>

      <h3 className="mb-2 mt-6 font-semibold">1. Contractual Necessity</h3>
      <p className="mb-2">Processing is necessary for:</p>
      <ul className="mb-4 list-disc pl-5">
        <li>The performance of a contract with merchants or business partners</li>
        <li>
          The implementation of pre-contractual measures (e.g., merchant
          onboarding, account verification)
        </li>
        <li>
          The fulfillment of service obligations related to payment facilitation
      ...
      <h3 className="mb-2 mt-6 font-semibold">3. Legitimate Business Interests</h3>
      <p className="mb-2">
        Processing may be necessary for legitimate business purposes, provided
        such interests are not overridden by the fundamental rights and
        freedoms of data subjects, including:
      </p>
      <ul className="mb-4 list-disc pl-5">
      ...
      <p>
        As a regulated entity, we may process personal data to comply with
        supervisory, licensing, audit, and reporting requirements imposed by
        competent authorities.
      </p>

      <h3 className="mb-2 mt-6 font-semibold">5. Consent (Where Applicable)</h3>
      <p>
        Where required by law, we will obtain the consent of the data subject
        before processing personal data. Consent may be withdrawn at any time,
      ...
      <p>
        Personal data may be disclosed only when necessary and appropriate for
        legitimate business or regulatory purposes.
      </p>
      <p>We may share personal data with:</p>

      <h3 className="mb-2 mt-6 font-semibold">1. Authorized Internal Personnel</h3>
      <p>
        Access is limited to employees, consultants, and authorized personnel
        strictly on a need-to-know basis and subject to confidentiality
        obligations.
      </p>
      ...
      <p>
        Where required for transaction processing, settlement, reconciliation,
      ...
      <p>
        For the purpose of facilitating merchant platform connectivity and
        payment-related services, subject to contractual safeguards.
      </p>
      ...
      <h3 className="mb-2 mt-6 font-semibold">Safeguards for Data Sharing</h3>
      ...
      <p>
        Personal data is not shared beyond what is necessary for the stated
        purposes.
      </p>
      ...
      <p>
        ...
        legitimate business and regulatory purposes.
      </p>
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          Regulatory requirements applicable to financial and payment-related
          services
        </li>
        <li>Operational necessity</li>
      </ul>
      <p className="mb-2">
        When personal data is no longer required for the stated purposes, it
        is:
      </p>
      <ul className="mb-4 list-disc pl-5">
        <li>Securely deleted using approved deletion procedures, or</li>
        <li>
          Irreversibly anonymized so that it can no longer be associated with
          an identifiable individual
        </li>
      </ul>
      <p>
        Secure disposal procedures are implemented to prevent unauthorized
        recovery, access, or reconstruction of deleted data.
      </p>
      ...
      <h3 className="mb-2 mt-6 font-semibold">1. Organizational Safeguards</h3>
      <ul className="mb-4 list-disc pl-5">
      ...
      <h3 className="mb-2 mt-6 font-semibold">2. Technical Safeguards</h3>
      <ul className="mb-4 list-disc pl-5">
      ...
      <h3 className="mb-2 mt-6 font-semibold">3. Physical Safeguards</h3>
      <ul className="mb-4 list-disc pl-5">
      ...
      <p>
        These safeguards are periodically reviewed and updated to address
        emerging risks and evolving regulatory requirements.
      </p>

      <h2>VIII. Your Rights as a Data Subject</h2>
      <p className="mb-2">
        In accordance with the Philippine Data Privacy Act and related
        regulations, individuals may exercise the following rights, subject to
        lawful limitations:
      </p>
      <ul className="mb-4 list-disc pl-5">
        <li>
          <strong>Right to Access.</strong> Request confirmation of whether
          personal data is being processed and obtain a copy of such data.
        </li>
        <li>
        ...
        <li>
          <strong>Right to Erasure or Blocking.</strong> Request deletion,
          suspension, or blocking of personal data where legally permissible.
        </li>
        <li>
          <strong>Right to Object.</strong> Object to processing based on
          legitimate interest or direct marketing, where applicable.
        </li>
        <li>
        ...
        <li>
          ...
          personal data in a structured, commonly used format, where technically
          feasible.
        </li>
        <li>
          <strong>Right to be Informed.</strong> Be informed about how personal
          data is collected and processed.
        </li>
        <li>
          <strong>Right to Lodge a Complaint.</strong> File a complaint with
          the relevant data protection authority if rights are believed to have
          been violated.
        </li>
      </ul>
      <p>Requests may be submitted using the contact details provided below.</p>
      <p>
        We may request reasonable verification of identity before acting on any
        request to protect personal data from unauthorized disclosure.
      </p>
      <p>Responses will be provided within applicable regulatory timelines.</p>

      <h2>IX. Data Breach Notification</h2>
      <p>
        In the event of a personal data breach that may pose a real risk to the
        rights and freedoms of individuals, we will take immediate and
        appropriate action in accordance with applicable data protection laws
        and regulatory requirements.
      </p>
      <p className="mb-2">Our response will include:</p>
      <ul className="mb-4 list-disc pl-5">
        <li>
          Prompt internal reporting to designated security and data protection
          officers
        </li>
        <li>
          Immediate investigation to determine the nature, scope, and impact of
          the incident
        </li>
        <li>
          Implementation of containment measures to prevent further
      ...
      <ul className="mb-4 list-disc pl-5">
        <li>
          Notify the appropriate regulatory authority within prescribed
          timelines
        </li>
        <li>
          Inform affected individuals without undue delay if there is a high
      ...
      <p>
        All incidents are documented, reviewed, and subject to corrective
        action to prevent recurrence.
      </p>

      <h2>X. Updates to This Privacy Notice</h2>
      <p>
        We may update this Privacy Notice from time to time to ensure continued
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          Where required, affected individuals may be notified through
          appropriate communication channels
        </li>
      </ul>
      <p>
        We encourage individuals to review this Privacy Notice periodically to
        stay informed about how we protect personal data.
      </p>

      <h2>XI. Contact Information</h2>
      <p>For privacy-related concerns, requests, or complaints, you may contact:</p>
      <div className="mt-4 rounded-xl border border-[var(--border-light)] bg-[var(--bg-base)] p-4 sm:p-6">
        <p className="mb-1">
