  ...
  },
  {
    ...
    logos: [
      ...
      },
      {
        ...
        marqueePosition: "center center",
        wrapperClassName:
          "h-[90px] w-[90px] rounded-[18px] bg-[#000000] p-3 shadow-[0_10px_24px_rgba(0,0,0,0.08)] sm:h-[92px] sm:w-[92px]",
        className: "h-full w-full object-contain",
      },
      {
        name: "SG",
        src: "/img/partners/sg.png",
        width: 132,
        height: 132,
        marqueeScale: 1.12,
        marqueeZoom: 1.18,
        marqueePosition: "center center",
        wrapperClassName:
          "h-[90px] w-[90px] rounded-[18px] bg-white p-3 shadow-[0_10px_24px_rgba(0,0,0,0.08)] sm:h-[92px] sm:w-[92px]",
        className: "h-full w-full object-contain",
      },
    ],
  },
  {
    ...
    logos: [
      ...
      },
      {
        ...
        marqueePosition: "center center",
        wrapperClassName:
          "h-[132px] w-[132px] rounded-[18px] bg-black p-0 shadow-[0_10px_24px_rgba(0,0,0,0.08)] sm:h-[132px] sm:w-[132px]",
